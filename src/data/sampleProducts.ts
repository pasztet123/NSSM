...
export const sampleProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'Roof Flashing',
    productType: 'other',
    description: 'Metal termination bar for securing roofing membranes',
    longDescription: 'Termination bar is used to mechanically fasten and secure the edge of roofing membranes, particularly in single-ply roofing systems. Provides a watertight seal and professional finish at membrane terminations.',
    basePrice: 0,
    currency: 'USD',
    images: [
      'https://abedward.com/wp-content/uploads/2026/01/termination-bar.webp',
    ],
    specifications: {
      material: 'Galvanized Steel / Aluminum',
      thickness: '24 gauge (0.024")',
      ...
      profile: 'Flat Bar',
      length: '10 ft standard',
      application: 'Membrane termination, parapet walls',
    },
    model3D: undefined,
    model3DId: '53cfd475-c68d-41fd-b573-7a2e1fec037d',
    model3DRotation: [0, 0, Math.PI / 2],
    selectedMaterial: 'steel-24ga-kynar',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'prod-11',
    name: 'Termination Bar with Lip',
    category: 'Roof Flashing',
    productType: 'other',
    description: 'Termination bar with integrated drip lip for enhanced water management',
    longDescription: 'Termination bar with lip combines membrane securement with a drip edge detail. The integrated lip ensures water is directed away from the wall or parapet, providing superior protection against water infiltration.',
    basePrice: 0,
    currency: 'USD',
    images: [
      'https://abedward.com/wp-content/uploads/2026/01/termination-bar-with-lip.webp',
    ],
    specifications: {
      material: 'Galvanized Steel / Aluminum',
      thickness: '24 gauge (0.024")',
      ...
      color: 'Custom colors available',
      width: '2" - 3"',
      profile: 'Bar with Drip Lip',
      length: '10 ft standard',
      application: 'Membrane termination with enhanced drainage',
    },
    model3D: undefined,
    model3DId: '4b1366ba-b1bd-4be5-b731-558bdb2edb05',
    model3DRotation: [0, 0, Math.PI / 2],
    selectedMaterial: 'aluminum-032-kynar',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
];
